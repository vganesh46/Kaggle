* Implemented code from https://github.com/radekosmulski/quickdraw that is based on pre-trained resnet architecture using fastai latest version built on pytorch v1. Got a score of 0.807 on PL
